...
class Animal {
	...
	public:
		...
		virtual void makeSound() const = 0; // virtual function = can be overridden in derived classes
		virtual void think(int index) const = 0; // pure virtual function making the class abstract
};
